...
> **이 파일은 마스터 문서입니다.**
> `com.auditor/CLAUDE.md` 와 `watcher.www/CLAUDE.md` 는 이 파일의 하위 스펙입니다.
...
| **App (sibling)** | `com.auditor/apps/{domain}/_docs/CLAUDE.md` | 특정 백엔드 앱 |

**우선순위:** **this file** > **child `CLAUDE.md`** > `_docs/{project}/` > `_docs/DevOps/*_RULES.md` > `FOUNDATIONS.md`

**문서 배치:** 공통 MD → [`_docs/`](_docs/) · Backend → [`com.auditor/_docs/`](com.auditor/_docs/) · Frontend → [`watcher.www/_docs/`](watcher.www/_docs/) · Flutter → [`flutter/_docs/`](flutter/_docs/)
...
3. Read [`_docs/DevOps/FOUNDATIONS.md`](_docs/DevOps/FOUNDATIONS.md) + stack rules
...
| 대상 | 로그 파일 경로 |
|---|---|
| 백엔드 | `com.auditor/_docs/backend_ver_log.md` |
| 프론트엔드 | `watcher.www/_docs/frontend_ver_log.md` |
...
| [`com.auditor/_docs/`](com.auditor/_docs/) | Backend PKS |
...
| `com.auditor/apps/{domain}/_docs/CLAUDE.md` | Per-app backend spec |
